...
class Graph_t {
 public:
  void input( ) {
    ...
    // создает вектор с пустыми множествами ( пустые списки смежности для каждой вершины )
  ...
  int vertex_number { 0 };
  int edges_number { 0 };
  // словарь, от вершины и ее отображение на множество вершин соседей
  // или списки смежности для каждой вершины
